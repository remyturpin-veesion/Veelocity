...
/// Individual PR Explorer: PR detail with reviews, comments, commits, optional health.
class PRDetailScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return BaseScaffold(
      ...
      child: asyncDetail.when(
        ...
        data: (pr) => _buildContent(context, pr),
      ),
    );
  }
  ...
  Widget _buildContent(BuildContext context, PRDetail pr) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          if (pr.limits != null &&
              pr.limits!.commentsTotal > pr.comments.length)
            Padding(
              padding: const EdgeInsets.only(bottom: 16),
              child: Text(
